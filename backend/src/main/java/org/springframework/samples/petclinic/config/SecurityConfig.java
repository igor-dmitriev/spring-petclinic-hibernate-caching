...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public JWTLoginFilter jwtLoginFilter() throws Exception {
    JWTLoginFilter jwtLoginFilter = new JWTLoginFilter("/login", tokenAuthentication(), objectMapper);
  ...
  public TokenAuthentication tokenAuthentication() {
    return new TokenAuthentication(expirationTimeSeconds, tokenPrefix, secretKey);
  }
